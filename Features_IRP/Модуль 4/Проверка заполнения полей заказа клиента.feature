...
Функционал: Заполнение полей Партнер, Клиент и Соглашение в заказе покупателя
...
* Поле Партнер еще пустое, поэтому сразу проверяю недоступность поля Клиент
    И Проверяю шаги на Исключение:
            |'И элемент формы "LegalName" доступен'|
...
* Проверяю доступность поля Клиент, когда поле Партнер заполнено
